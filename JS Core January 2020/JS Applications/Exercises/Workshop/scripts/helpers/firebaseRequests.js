import { apiKey } from '../../firebaseSettings.js';
import { HideLoadingShowCheck } from '../handlers/index.js';
export const fireBaseRequestFactory = (collectionName, token = null) => {
	HideLoadingShowCheck();
	if (!apiKey) {
